...
object Consumer extends App {
  ...
  consumerProperties.setProperty(BOOTSTRAP_SERVERS_CONFIG, "localhost:2181")
  consumerProperties.setProperty(GROUP_ID_CONFIG, "consumer-group")
  ...
  consumer.subscribe(List("test-1").asJava)
