  ...
  def main(args: Array[String]): Unit = {
    ...
    val writeToConsoleAndFile = (batchDF: org.apache.spark.sql.DataFrame, batchId: Long) => {
      ...
      batchDF.write
        ...
        .option("path", "/mnt/c/Users/Vincent/INDE_GRP5/spark_output/batch_output") // Remplacer par le chemin de votre répertoire de sortie
        .save()
    }
    ...
    val query = dataWithTimestamp
     ...
     .format("csv") // Utiliser 'parquet', 'json', ou autre format de fichier
     .option("path", "/mnt/c/Users/Vincent/INDE_GRP5/spark_output/batch_output") // Remplacer par le chemin de votre répertoire de sortie
     .option("checkpointLocation", "/mnt/c/Users/Vincent/INDE_GRP5/spark_output/batch_checkpoint") // Chemin pour la sauvegarde de point de contrôle
